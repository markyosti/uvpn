#ifndef CLIENT_CRYPTO_CONNECTION_MANAGER_H
# define CLIENT_CRYPTO_CONNECTION_MANAGER_H
...
class ClientCryptoConnectionManager : public ClientConnectionManager {
 public:
  ClientCryptoConnectionManager(Prng* prng, Dispatcher* dispatcher);
  ~ClientCryptoConnectionManager() {}
 ...
 private:
  class Session : public ClientConnectedSession {
   public:
    Session(ClientCryptoConnectionManager* parent,
	    UserChatter* chatter,
	    ClientTranscoder::Connection* connection,
   ...
   private:
    ...
    ClientCryptoConnectionManager* parent_;
...
#endif // CLIENT_CRYPTO_CONNECTION_MANAGER_H
